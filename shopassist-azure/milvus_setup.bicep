// Bicep file to deploy a VM with Milvus using Docker Compose
// Usage: az deployment group create --name deploy-milvus --resource-group rg-milvus-test-01 --template-file main.bicep --parameters adminPassword=<passwordhere>
